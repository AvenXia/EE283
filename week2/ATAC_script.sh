...
DestDir="/data/homezvol0/qingyux3/EE283/problem2/ATACseq/rawdata"
File="/data/homezvol0/qingyux3/EE283/problem2/ATACseq/rawdata/ATACseq.labels.txt "
while read p
do
   echo "${p}"
   ...
   READ2=$(find ${SourceDir}/ -type f -iname "*_${barcode}_*R2.fastq.gz")
